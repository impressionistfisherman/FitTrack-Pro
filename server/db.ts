...
const supplementalExercises = [
  ...
  },
  {
    ...
    category: "endurance",
    difficulty: "beginner",
    description: "Seated bodyweight core exercise bringing the knees toward the chest.",
    descriptionKo: "앉은 자세에서 무릎을 가슴 쪽으로 당기는 기본 맨몸 복근 운동입니다.",
    primaryMuscles: ["rectus abdominis", "hip flexors"],
    secondaryMuscles: ["obliques"],
    instructions: ["벤치나 바닥에 앉아 양손으로 몸을 가볍게 지지합니다.", "상체를 살짝 뒤로 기울이고 무릎을 가슴 쪽으로 당깁니다.", "복근을 수축한 뒤 다리를 천천히 펴며 반복합니다.", "허리가 과하게 말리거나 꺾이지 않게 유지합니다."],
  },
  {
    name: "Dumbbell Press",
    nameKo: "덤벨 프레스",
    ...
    category: "strength",
    difficulty: "beginner",
    description: "Basic flat dumbbell chest press pattern without extra variation wording.",
    descriptionKo: "복잡한 변형명 없이 검색할 수 있는 기본 덤벨 체스트 프레스 항목입니다.",
    primaryMuscles: ["pectoralis major"],
    secondaryMuscles: ["anterior deltoid", "triceps"],
    instructions: ["플랫 벤치에 누워 양손에 덤벨을 듭니다.", "덤벨을 체스트 옆까지 천천히 내립니다.", "손목과 팔꿈치를 안정적으로 유지하며 위로 프레스합니다.", "반동 없이 같은 궤도로 반복합니다."],
  },
  {
    ...
    category: "strength",
    difficulty: "beginner",
    description: "Basic machine chest press for users searching by common gym wording.",
    descriptionKo: "헬스장에서 흔히 쓰는 체스트 프레스 머신 기본 항목입니다.",
    primaryMuscles: ["pectoralis major"],
    secondaryMuscles: ["anterior deltoid", "triceps"],
    instructions: ["시트 높이를 손잡이가 체스트 중앙에 오도록 맞춥니다.", "견갑을 안정적으로 고정합니다.", "손잡이를 앞으로 프레스합니다.", "무게를 놓치지 말고 천천히 돌아옵니다."],
  },
  {
    ...
    category: "strength",
    difficulty: "beginner",
    description: "Basic smith machine bench press.",
    descriptionKo: "스미스 머신으로 수행하는 기본 벤치프레스입니다.",
    primaryMuscles: ["pectoralis major"],
    secondaryMuscles: ["anterior deltoid", "triceps"],
    instructions: ["벤치를 스미스 머신 바 아래에 맞춥니다.", "바를 체스트 중앙까지 내립니다.", "궤도를 유지하며 위로 프레스합니다."],
  },
  {
    ...
    category: "strength",
    difficulty: "beginner",
    description: "Basic incline dumbbell chest press.",
    descriptionKo: "인클라인 벤치에서 수행하는 기본 덤벨 체스트 프레스입니다.",
    primaryMuscles: ["upper pectoralis major"],
    secondaryMuscles: ["anterior deltoid", "triceps"],
    instructions: ["벤치를 인클라인으로 맞춥니다.", "덤벨을 체스트 옆까지 내립니다.", "상체 각도를 유지하며 프레스합니다."],
  },
  {
    ...
    category: "strength",
    difficulty: "intermediate",
    description: "Basic decline dumbbell chest press.",
    descriptionKo: "디클라인 벤치에서 수행하는 기본 덤벨 체스트 프레스입니다.",
    primaryMuscles: ["lower pectoralis major"],
    secondaryMuscles: ["triceps", "anterior deltoid"],
    instructions: ["디클라인 벤치에 안정적으로 고정합니다.", "덤벨을 체스트 옆까지 내립니다.", "팔꿈치 각도를 유지하며 프레스합니다."],
  },
  {
    ...
    category: "strength",
    difficulty: "beginner",
    description: "Basic standing or bench cable chest press.",
    descriptionKo: "케이블로 수행하는 기본 체스트 프레스입니다.",
    primaryMuscles: ["pectoralis major"],
    secondaryMuscles: ["anterior deltoid", "triceps"],
    instructions: ["케이블 높이를 체스트 라인에 맞춥니다.", "몸통을 고정합니다.", "손잡이를 앞으로 프레스합니다."],
  },
  {
    name: "Shoulder Press",
    nameKo: "숄더 프레스",
    ...
    category: "strength",
    difficulty: "beginner",
    description: "Basic shoulder press pattern.",
    descriptionKo: "기본 숄더 프레스 항목입니다.",
    primaryMuscles: ["deltoids"],
    secondaryMuscles: ["triceps", "upper chest"],
    instructions: ["손잡이가 어깨 높이에 오도록 맞춥니다.", "허리를 과하게 젖히지 않습니다.", "머리 위로 프레스합니다."],
  },
  {
    ...
    category: "strength",
    difficulty: "beginner",
    description: "Basic machine shoulder press.",
    descriptionKo: "머신으로 수행하는 기본 숄더 프레스입니다.",
    primaryMuscles: ["deltoids"],
    secondaryMuscles: ["triceps"],
    instructions: ["시트 높이를 맞춥니다.", "손목을 세운 채 손잡이를 잡습니다.", "팔꿈치를 완전히 잠그지 않고 프레스합니다."],
  },
  {
    name: "Lateral Raise",
    nameKo: "레터럴 레이즈",
    ...
    difficulty: "beginner",
    description: "Basic side delt raise.",
    descriptionKo: "측면 델트를 자극하는 기본 레터럴 레이즈입니다.",
    primaryMuscles: ["lateral deltoids"],
    secondaryMuscles: ["traps"],
    instructions: ["덤벨을 몸 옆에 둡니다.", "팔꿈치를 살짝 굽힌 채 옆으로 올립니다.", "반동 없이 천천히 내립니다."],
  },
  {
    name: "Rear Delt Fly",
    nameKo: "리어 델트 플라이",
    ...
    category: "hypertrophy",
    difficulty: "beginner",
    description: "Basic rear delt fly.",
    descriptionKo: "후면 델트를 자극하는 기본 리어 델트 플라이입니다.",
    primaryMuscles: ["rear deltoids"],
    secondaryMuscles: ["upper back"],
    instructions: ["상체를 숙여 덤벨을 잡습니다.", "팔을 양옆으로 벌립니다.", "후면 델트 수축을 느끼며 돌아옵니다."],
  },
  {
    name: "Lat Pulldown",
    nameKo: "랫풀다운",
    ...
    category: "strength",
    difficulty: "beginner",
    description: "Basic lat pulldown.",
    descriptionKo: "랫을 자극하는 기본 풀다운입니다.",
    primaryMuscles: ["lats"],
    secondaryMuscles: ["biceps", "rear delts"],
    instructions: ["패드를 허벅지에 고정합니다.", "바를 체스트 위쪽으로 당깁니다.", "어깨가 으쓱하지 않게 천천히 올립니다."],
  },
  {
    name: "Seated Row",
    nameKo: "시티드 로우",
    ...
    category: "strength",
    difficulty: "beginner",
    description: "Basic seated row.",
    descriptionKo: "시티드 자세에서 수행하는 기본 로우입니다.",
    primaryMuscles: ["lats", "middle back"],
    secondaryMuscles: ["biceps", "rear delts"],
    instructions: ["가슴을 세우고 손잡이를 잡습니다.", "팔꿈치를 뒤로 당깁니다.", "견갑을 모은 뒤 천천히 돌아옵니다."],
  },
  {
    name: "Machine Row",
    nameKo: "머신 로우",
    ...
    category: "strength",
    difficulty: "beginner",
    description: "Basic machine row.",
    descriptionKo: "머신으로 수행하는 기본 로우입니다.",
    primaryMuscles: ["middle back", "lats"],
    secondaryMuscles: ["biceps", "rear delts"],
    instructions: ["패드에 체스트를 고정합니다.", "손잡이를 몸쪽으로 당깁니다.", "견갑을 모으고 천천히 돌아옵니다."],
  },
  {
    name: "Cable Row",
    nameKo: "케이블 로우",
    ...
    category: "strength",
    difficulty: "beginner",
    description: "Basic cable row.",
    descriptionKo: "케이블로 수행하는 기본 로우입니다.",
    primaryMuscles: ["lats", "middle back"],
    secondaryMuscles: ["biceps"],
    instructions: ["케이블 앞에 앉아 허리를 세웁니다.", "손잡이를 복부 쪽으로 당깁니다.", "반동 없이 천천히 팔을 폅니다."],
  },
  {
    name: "Dumbbell Row",
    nameKo: "덤벨 로우",
    ...
    category: "strength",
    difficulty: "beginner",
    description: "Basic dumbbell row.",
    descriptionKo: "덤벨로 수행하는 기본 로우입니다.",
    primaryMuscles: ["lats", "middle back"],
    secondaryMuscles: ["biceps", "rear delts"],
    instructions: ["상체를 숙이고 덤벨을 잡습니다.", "팔꿈치를 뒤로 당깁니다.", "허리가 말리지 않게 반복합니다."],
  },
  {
    name: "Squat",
    nameKo: "스쿼트",
    ...
    descriptionKo: "기본 스쿼트 패턴입니다.",
    primaryMuscles: ["quadriceps", "glutes"],
    secondaryMuscles: ["hamstrings", "core"],
    instructions: ["발을 어깨너비로 둡니다.", "무릎과 발끝 방향을 맞춥니다.", "엉덩이를 뒤로 보내며 앉았다 일어납니다."],
  },
  {
    ...
    category: "strength",
    difficulty: "beginner",
    description: "Basic smith machine squat.",
    descriptionKo: "스미스 머신으로 수행하는 기본 스쿼트입니다.",
    primaryMuscles: ["quadriceps", "glutes"],
    secondaryMuscles: ["hamstrings", "core"],
    instructions: ["바를 등 상부에 둡니다.", "발 위치를 안정적으로 잡습니다.", "무릎 방향을 유지하며 앉았다 일어납니다."],
  },
  {
    name: "Leg Press",
    nameKo: "레그 프레스",
    ...
    category: "strength",
    difficulty: "beginner",
    description: "Basic leg press.",
    descriptionKo: "머신으로 수행하는 기본 레그 프레스입니다.",
    primaryMuscles: ["quadriceps", "glutes"],
    secondaryMuscles: ["hamstrings"],
    instructions: ["발을 발판에 안정적으로 둡니다.", "무릎을 굽혀 무게를 내립니다.", "허리가 뜨지 않게 밀어냅니다."],
  },
  {
    name: "Leg Extension",
    nameKo: "레그 익스텐션",
    ...
    category: "hypertrophy",
    difficulty: "beginner",
    description: "Basic leg extension.",
    descriptionKo: "쿼드리셉스를 자극하는 기본 레그 익스텐션입니다.",
    primaryMuscles: ["quadriceps"],
    secondaryMuscles: [],
    instructions: ["무릎 축을 머신 축에 맞춥니다.", "패드를 발목 앞에 둡니다.", "다리를 펴고 천천히 내립니다."],
  },
  {
    name: "Leg Curl",
    nameKo: "레그 컬",
    ...
    category: "hypertrophy",
    difficulty: "beginner",
    description: "Basic leg curl.",
    descriptionKo: "햄스트링을 자극하는 기본 레그 컬입니다.",
    primaryMuscles: ["hamstrings"],
    secondaryMuscles: ["calves"],
    instructions: ["패드를 발목 뒤에 맞춥니다.", "무릎을 접어 패드를 당깁니다.", "천천히 버티며 돌아옵니다."],
  },
  {
    name: "Hip Adduction",
    nameKo: "이너싸이 머신",
    ...
    category: "hypertrophy",
    difficulty: "beginner",
    description: "Basic hip adduction machine.",
    descriptionKo: "이너싸이를 자극하는 기본 어덕션 머신입니다.",
    primaryMuscles: ["adductors"],
    secondaryMuscles: [],
    instructions: ["등을 패드에 붙입니다.", "허벅지를 안쪽으로 모읍니다.", "반동 없이 천천히 벌립니다."],
  },
  {
    name: "Hip Abduction",
    nameKo: "아웃싸이 머신",
    ...
    category: "hypertrophy",
    difficulty: "beginner",
    description: "Basic hip abduction machine.",
    descriptionKo: "아웃싸이를 자극하는 기본 어브덕션 머신입니다.",
    primaryMuscles: ["abductors", "glutes"],
    secondaryMuscles: [],
    instructions: ["등을 패드에 붙입니다.", "허벅지를 바깥쪽으로 벌립니다.", "천천히 모으며 장력을 유지합니다."],
  },
  {
    name: "Biceps Curl",
    nameKo: "바이셉 컬",
    ...
    category: "hypertrophy",
    difficulty: "beginner",
    description: "Basic biceps curl.",
    descriptionKo: "바이셉을 자극하는 기본 컬입니다.",
    primaryMuscles: ["biceps"],
    secondaryMuscles: ["forearms"],
    instructions: ["팔꿈치를 몸 옆에 둡니다.", "손목을 세운 채 들어 올립니다.", "천천히 내리며 반복합니다."],
  },
  {
    name: "Cable Curl",
    nameKo: "케이블 컬",
    ...
    category: "hypertrophy",
    difficulty: "beginner",
    description: "Basic cable curl.",
    descriptionKo: "케이블로 수행하는 기본 컬입니다.",
    primaryMuscles: ["biceps"],
    secondaryMuscles: ["forearms"],
    instructions: ["하단 케이블에 바를 연결합니다.", "팔꿈치를 고정합니다.", "바를 들어 올리고 천천히 내립니다."],
  },
  {
    name: "Preacher Curl",
    nameKo: "프리처 컬",
    ...
    category: "hypertrophy",
    difficulty: "beginner",
    description: "Basic preacher curl.",
    descriptionKo: "프리처 패드에서 수행하는 기본 컬입니다.",
    primaryMuscles: ["biceps"],
    secondaryMuscles: ["forearms"],
    instructions: ["팔을 패드에 고정합니다.", "팔꿈치를 들지 않고 컬합니다.", "끝까지 통제하며 내립니다."],
  },
  {
    ...
    category: "hypertrophy",
    difficulty: "beginner",
    description: "Basic triceps pushdown.",
    descriptionKo: "트라이셉을 자극하는 기본 푸시다운입니다.",
    primaryMuscles: ["triceps"],
    secondaryMuscles: [],
    instructions: ["상단 케이블에 바를 연결합니다.", "팔꿈치를 몸 옆에 고정합니다.", "아래로 밀고 천천히 돌아옵니다."],
  },
  {
    ...
    category: "hypertrophy",
    difficulty: "beginner",
    description: "Basic triceps extension.",
    descriptionKo: "트라이셉을 자극하는 기본 익스텐션입니다.",
    primaryMuscles: ["triceps"],
    secondaryMuscles: [],
    instructions: ["팔꿈치 위치를 고정합니다.", "팔을 굽혀 무게를 내립니다.", "트라이셉으로 팔을 폅니다."],
  },
  {
    name: "Crunch",
    nameKo: "크런치",
    ...
    descriptionKo: "복근을 자극하는 기본 크런치입니다.",
    primaryMuscles: ["abdominals"],
    secondaryMuscles: [],
    instructions: ["무릎을 세우고 눕습니다.", "복근으로 상체를 말아 올립니다.", "목에 힘을 주지 않고 내려옵니다."],
  },
  {
    name: "Treadmill",
    nameKo: "트레드밀",
    ...
    category: "cardio",
    difficulty: "beginner",
    description: "Basic treadmill walking or running.",
    descriptionKo: "트레드밀 걷기 또는 러닝입니다.",
    primaryMuscles: ["cardiovascular system", "legs"],
    secondaryMuscles: ["core"],
    instructions: ["속도를 낮게 시작합니다.", "보폭을 안정적으로 유지합니다.", "운동 후 천천히 속도를 줄입니다."],
  },
  {
    ...
    category: "cardio",
    difficulty: "beginner",
    description: "Basic stationary bike cardio.",
    descriptionKo: "실내 싸이클 기본 유산소 운동입니다.",
  ...
  ...basicGymExercises,
  {
    ...
    category: "hypertrophy",
    difficulty: "beginner",
    description: "Basic cable hammer curl using a neutral grip.",
    descriptionKo: "케이블을 중립 그립으로 당겨 상완근과 이두근을 자극하는 기본 운동입니다.",
    primaryMuscles: ["brachialis", "biceps"],
    secondaryMuscles: ["forearms"],
    instructions: ["하단 케이블에 로프 또는 중립 그립 핸들을 연결합니다.", "팔꿈치를 몸 옆에 고정합니다.", "손목을 중립으로 유지하며 손잡이를 들어 올립니다.", "천천히 내리며 케이블 장력을 유지합니다."],
  },
  {
...
function createBasicGymExercises() {
  const rows = [
    { name: "Incline Barbell Press", nameKo: "인클라인 바벨 프레스", bodyPart: "chest", equipment: "barbell", category: "strength", difficulty: "intermediate", primaryMuscles: ["upper pectoralis major"], secondaryMuscles: ["anterior deltoid", "triceps"] },
    { name: "Decline Barbell Press", nameKo: "디클라인 바벨 프레스", bodyPart: "chest", equipment: "barbell", category: "strength", difficulty: "intermediate", primaryMuscles: ["lower pectoralis major"], secondaryMuscles: ["triceps", "anterior deltoid"] },
    { name: "Close Grip Bench Press", nameKo: "클로즈 그립 벤치프레스", bodyPart: "arms", equipment: "barbell", category: "strength", difficulty: "intermediate", primaryMuscles: ["triceps"], secondaryMuscles: ["pectoralis major", "anterior deltoid"] },
    { name: "Wide Grip Bench Press", nameKo: "와이드 그립 벤치프레스", bodyPart: "chest", equipment: "barbell", category: "strength", difficulty: "intermediate", primaryMuscles: ["pectoralis major"], secondaryMuscles: ["anterior deltoid", "triceps"] },
    { name: "Dumbbell Squeeze Press", nameKo: "덤벨 스퀴즈 프레스", bodyPart: "chest", equipment: "dumbbell", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["pectoralis major"], secondaryMuscles: ["triceps"] },
    { name: "Machine Fly", nameKo: "머신 플라이", bodyPart: "chest", equipment: "machine", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["pectoralis major"], secondaryMuscles: ["anterior deltoid"] },
    { name: "Cable Fly", nameKo: "케이블 플라이", bodyPart: "chest", equipment: "cable", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["pectoralis major"], secondaryMuscles: ["anterior deltoid"] },
    { name: "Incline Cable Fly", nameKo: "인클라인 케이블 플라이", bodyPart: "chest", equipment: "cable", category: "hypertrophy", difficulty: "intermediate", primaryMuscles: ["upper pectoralis major"], secondaryMuscles: ["anterior deltoid"] },
    { name: "Decline Cable Fly", nameKo: "디클라인 케이블 플라이", bodyPart: "chest", equipment: "cable", category: "hypertrophy", difficulty: "intermediate", primaryMuscles: ["lower pectoralis major"], secondaryMuscles: ["anterior deltoid"] },
    { name: "Push Up", nameKo: "푸시업", bodyPart: "chest", equipment: "bodyweight", category: "strength", difficulty: "beginner", primaryMuscles: ["pectoralis major"], secondaryMuscles: ["triceps", "core"] },
    { name: "Incline Push Up", nameKo: "인클라인 푸시업", bodyPart: "chest", equipment: "bodyweight", category: "strength", difficulty: "beginner", primaryMuscles: ["pectoralis major"], secondaryMuscles: ["triceps", "anterior deltoid"] },
    { name: "Decline Push Up", nameKo: "디클라인 푸시업", bodyPart: "chest", equipment: "bodyweight", category: "strength", difficulty: "intermediate", primaryMuscles: ["upper pectoralis major"], secondaryMuscles: ["triceps", "anterior deltoid"] },
    { name: "Chest Dip", nameKo: "체스트 딥", bodyPart: "chest", equipment: "bodyweight", category: "strength", difficulty: "intermediate", primaryMuscles: ["pectoralis major"], secondaryMuscles: ["triceps", "anterior deltoid"] },

    { name: "Barbell Row", nameKo: "바벨 로우", bodyPart: "back", equipment: "barbell", category: "strength", difficulty: "intermediate", primaryMuscles: ["lats", "middle back"], secondaryMuscles: ["biceps", "rear delts"] },
    { name: "T Bar Row", nameKo: "티바 로우", bodyPart: "back", equipment: "barbell", category: "strength", difficulty: "intermediate", primaryMuscles: ["middle back", "lats"], secondaryMuscles: ["biceps", "rear delts"] },
    { name: "Chest Supported Row", nameKo: "체스트 서포티드 로우", bodyPart: "back", equipment: "machine", category: "strength", difficulty: "beginner", primaryMuscles: ["middle back", "lats"], secondaryMuscles: ["biceps"] },
    { name: "One Arm Dumbbell Row", nameKo: "원암 덤벨 로우", bodyPart: "back", equipment: "dumbbell", category: "strength", difficulty: "beginner", primaryMuscles: ["lats"], secondaryMuscles: ["biceps", "rear delts"] },
    { name: "Inverted Row", nameKo: "인버티드 로우", bodyPart: "back", equipment: "bodyweight", category: "strength", difficulty: "beginner", primaryMuscles: ["middle back", "lats"], secondaryMuscles: ["biceps", "core"] },
    { name: "Pull Up", nameKo: "풀업", bodyPart: "back", equipment: "bodyweight", category: "strength", difficulty: "intermediate", primaryMuscles: ["lats"], secondaryMuscles: ["biceps", "rear delts"] },
    { name: "Chin Up", nameKo: "친업", bodyPart: "back", equipment: "bodyweight", category: "strength", difficulty: "intermediate", primaryMuscles: ["lats", "biceps"], secondaryMuscles: ["middle back"] },
    { name: "Assisted Pull Up", nameKo: "어시스트 풀업", bodyPart: "back", equipment: "machine", category: "strength", difficulty: "beginner", primaryMuscles: ["lats"], secondaryMuscles: ["biceps"] },
    { name: "Wide Grip Lat Pulldown", nameKo: "와이드 그립 랫풀다운", bodyPart: "back", equipment: "machine", category: "strength", difficulty: "beginner", primaryMuscles: ["lats"], secondaryMuscles: ["biceps", "rear delts"] },
    { name: "Close Grip Lat Pulldown", nameKo: "클로즈 그립 랫풀다운", bodyPart: "back", equipment: "machine", category: "strength", difficulty: "beginner", primaryMuscles: ["lats"], secondaryMuscles: ["biceps"] },
    { name: "Reverse Grip Lat Pulldown", nameKo: "리버스 그립 랫풀다운", bodyPart: "back", equipment: "machine", category: "strength", difficulty: "beginner", primaryMuscles: ["lats"], secondaryMuscles: ["biceps"] },
    { name: "Straight Arm Pulldown", nameKo: "스트레이트 암 풀다운", bodyPart: "back", equipment: "cable", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["lats"], secondaryMuscles: ["triceps"] },
    { name: "Back Extension", nameKo: "백 익스텐션", bodyPart: "back", equipment: "bodyweight", category: "strength", difficulty: "beginner", primaryMuscles: ["lower back"], secondaryMuscles: ["glutes", "hamstrings"] },
    { name: "Hyperextension", nameKo: "하이퍼익스텐션", bodyPart: "back", equipment: "bodyweight", category: "strength", difficulty: "beginner", primaryMuscles: ["lower back"], secondaryMuscles: ["glutes", "hamstrings"] },

    { name: "Barbell Shoulder Press", nameKo: "바벨 숄더 프레스", bodyPart: "shoulders", equipment: "barbell", category: "strength", difficulty: "intermediate", primaryMuscles: ["deltoids"], secondaryMuscles: ["triceps", "upper chest"] },
    { name: "Dumbbell Shoulder Press", nameKo: "덤벨 숄더 프레스", bodyPart: "shoulders", equipment: "dumbbell", category: "strength", difficulty: "beginner", primaryMuscles: ["deltoids"], secondaryMuscles: ["triceps"] },
    { name: "Arnold Press", nameKo: "아놀드 프레스", bodyPart: "shoulders", equipment: "dumbbell", category: "hypertrophy", difficulty: "intermediate", primaryMuscles: ["deltoids"], secondaryMuscles: ["triceps"] },
    { name: "Front Raise", nameKo: "프론트 레이즈", bodyPart: "shoulders", equipment: "dumbbell", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["anterior deltoid"], secondaryMuscles: ["upper chest"] },
    { name: "Cable Lateral Raise", nameKo: "케이블 레터럴 레이즈", bodyPart: "shoulders", equipment: "cable", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["lateral deltoids"], secondaryMuscles: ["traps"] },
    { name: "Machine Lateral Raise", nameKo: "머신 레터럴 레이즈", bodyPart: "shoulders", equipment: "machine", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["lateral deltoids"], secondaryMuscles: ["traps"] },
    { name: "Reverse Pec Deck", nameKo: "리버스 펙덱", bodyPart: "shoulders", equipment: "machine", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["rear deltoids"], secondaryMuscles: ["upper back"] },
    { name: "Face Pull", nameKo: "페이스 풀", bodyPart: "shoulders", equipment: "cable", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["rear deltoids"], secondaryMuscles: ["traps", "rotator cuff"] },
    { name: "Upright Row", nameKo: "업라이트 로우", bodyPart: "shoulders", equipment: "barbell", category: "hypertrophy", difficulty: "intermediate", primaryMuscles: ["deltoids"], secondaryMuscles: ["traps", "biceps"] },
    { name: "Shrug", nameKo: "슈러그", bodyPart: "shoulders", equipment: "dumbbell", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["traps"], secondaryMuscles: ["forearms"] },

    { name: "Barbell Squat", nameKo: "바벨 스쿼트", bodyPart: "legs", equipment: "barbell", category: "strength", difficulty: "intermediate", primaryMuscles: ["quadriceps", "glutes"], secondaryMuscles: ["hamstrings", "core"] },
    { name: "Front Squat", nameKo: "프론트 스쿼트", bodyPart: "legs", equipment: "barbell", category: "strength", difficulty: "intermediate", primaryMuscles: ["quadriceps"], secondaryMuscles: ["glutes", "core"] },
    { name: "Hack Squat", nameKo: "핵 스쿼트", bodyPart: "legs", equipment: "machine", category: "strength", difficulty: "beginner", primaryMuscles: ["quadriceps"], secondaryMuscles: ["glutes", "hamstrings"] },
    { name: "Goblet Squat", nameKo: "고블릿 스쿼트", bodyPart: "legs", equipment: "dumbbell", category: "strength", difficulty: "beginner", primaryMuscles: ["quadriceps", "glutes"], secondaryMuscles: ["core"] },
    { name: "Bulgarian Split Squat", nameKo: "불가리안 스플릿 스쿼트", bodyPart: "legs", equipment: "dumbbell", category: "strength", difficulty: "intermediate", primaryMuscles: ["quadriceps", "glutes"], secondaryMuscles: ["hamstrings", "core"] },
    { name: "Split Squat", nameKo: "스플릿 스쿼트", bodyPart: "legs", equipment: "dumbbell", category: "strength", difficulty: "beginner", primaryMuscles: ["quadriceps", "glutes"], secondaryMuscles: ["hamstrings"] },
    { name: "Lunge", nameKo: "런지", bodyPart: "legs", equipment: "bodyweight", category: "strength", difficulty: "beginner", primaryMuscles: ["quadriceps", "glutes"], secondaryMuscles: ["hamstrings", "core"] },
    { name: "Walking Lunge", nameKo: "워킹 런지", bodyPart: "legs", equipment: "dumbbell", category: "strength", difficulty: "beginner", primaryMuscles: ["quadriceps", "glutes"], secondaryMuscles: ["hamstrings", "core"] },
    { name: "Romanian Deadlift", nameKo: "루마니안 데드리프트", bodyPart: "legs", equipment: "barbell", category: "strength", difficulty: "intermediate", primaryMuscles: ["hamstrings", "glutes"], secondaryMuscles: ["lower back"] },
    { name: "Dumbbell Romanian Deadlift", nameKo: "덤벨 루마니안 데드리프트", bodyPart: "legs", equipment: "dumbbell", category: "strength", difficulty: "beginner", primaryMuscles: ["hamstrings", "glutes"], secondaryMuscles: ["lower back"] },
    { name: "Deadlift", nameKo: "데드리프트", bodyPart: "back", equipment: "barbell", category: "strength", difficulty: "intermediate", primaryMuscles: ["posterior chain"], secondaryMuscles: ["lats", "traps", "core"] },
    { name: "Sumo Deadlift", nameKo: "스모 데드리프트", bodyPart: "legs", equipment: "barbell", category: "strength", difficulty: "intermediate", primaryMuscles: ["glutes", "hamstrings", "adductors"], secondaryMuscles: ["lower back", "core"] },
    { name: "Seated Leg Curl", nameKo: "시티드 레그 컬", bodyPart: "legs", equipment: "machine", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["hamstrings"], secondaryMuscles: ["calves"] },
    { name: "Lying Leg Curl", nameKo: "라잉 레그 컬", bodyPart: "legs", equipment: "machine", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["hamstrings"], secondaryMuscles: ["calves"] },
    { name: "Standing Calf Raise", nameKo: "스탠딩 카프 레이즈", bodyPart: "legs", equipment: "machine", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["calves"], secondaryMuscles: [] },
    { name: "Seated Calf Raise", nameKo: "시티드 카프 레이즈", bodyPart: "legs", equipment: "machine", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["calves"], secondaryMuscles: [] },

    { name: "Hip Thrust", nameKo: "힙 스러스트", bodyPart: "glutes", equipment: "barbell", category: "strength", difficulty: "beginner", primaryMuscles: ["glutes"], secondaryMuscles: ["hamstrings", "core"] },
    { name: "Glute Bridge", nameKo: "글루트 브리지", bodyPart: "glutes", equipment: "bodyweight", category: "strength", difficulty: "beginner", primaryMuscles: ["glutes"], secondaryMuscles: ["hamstrings"] },
    { name: "Cable Kickback", nameKo: "케이블 킥백", bodyPart: "glutes", equipment: "cable", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["glutes"], secondaryMuscles: ["hamstrings"] },
    { name: "Hip Extension", nameKo: "힙 익스텐션", bodyPart: "glutes", equipment: "machine", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["glutes"], secondaryMuscles: ["hamstrings"] },
    { name: "Step Up", nameKo: "스텝업", bodyPart: "legs", equipment: "dumbbell", category: "strength", difficulty: "beginner", primaryMuscles: ["quadriceps", "glutes"], secondaryMuscles: ["hamstrings", "core"] },

    { name: "Barbell Curl", nameKo: "바벨 컬", bodyPart: "arms", equipment: "barbell", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["biceps"], secondaryMuscles: ["forearms"] },
    { name: "Dumbbell Curl", nameKo: "덤벨 컬", bodyPart: "arms", equipment: "dumbbell", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["biceps"], secondaryMuscles: ["forearms"] },
    { name: "Hammer Curl", nameKo: "해머 컬", bodyPart: "arms", equipment: "dumbbell", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["brachialis", "biceps"], secondaryMuscles: ["forearms"] },
    { name: "Incline Dumbbell Curl", nameKo: "인클라인 덤벨 컬", bodyPart: "arms", equipment: "dumbbell", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["biceps"], secondaryMuscles: ["forearms"] },
    { name: "Concentration Curl", nameKo: "컨센트레이션 컬", bodyPart: "arms", equipment: "dumbbell", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["biceps"], secondaryMuscles: ["forearms"] },
    { name: "Skull Crusher", nameKo: "스컬 크러셔", bodyPart: "arms", equipment: "barbell", category: "hypertrophy", difficulty: "intermediate", primaryMuscles: ["triceps"], secondaryMuscles: [] },
    { name: "Cable Triceps Extension", nameKo: "케이블 트라이셉 익스텐션", bodyPart: "arms", equipment: "cable", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["triceps"], secondaryMuscles: [] },
    { name: "Overhead Triceps Extension", nameKo: "오버헤드 트라이셉 익스텐션", bodyPart: "arms", equipment: "dumbbell", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["triceps"], secondaryMuscles: [] },
    { name: "Triceps Dip", nameKo: "트라이셉 딥", bodyPart: "arms", equipment: "bodyweight", category: "strength", difficulty: "beginner", primaryMuscles: ["triceps"], secondaryMuscles: ["pectoralis major", "anterior deltoid"] },
    { name: "Wrist Curl", nameKo: "리스트 컬", bodyPart: "arms", equipment: "dumbbell", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["forearms"], secondaryMuscles: [] },

    { name: "Plank", nameKo: "플랭크", bodyPart: "abs", equipment: "bodyweight", category: "strength", difficulty: "beginner", primaryMuscles: ["core"], secondaryMuscles: ["glutes", "shoulders"] },
    { name: "Side Plank", nameKo: "사이드 플랭크", bodyPart: "abs", equipment: "bodyweight", category: "strength", difficulty: "beginner", primaryMuscles: ["obliques", "core"], secondaryMuscles: ["shoulders"] },
    { name: "Leg Raise", nameKo: "레그 레이즈", bodyPart: "abs", equipment: "bodyweight", category: "strength", difficulty: "beginner", primaryMuscles: ["abdominals", "hip flexors"], secondaryMuscles: [] },
    { name: "Hanging Leg Raise", nameKo: "행잉 레그 레이즈", bodyPart: "abs", equipment: "bodyweight", category: "strength", difficulty: "intermediate", primaryMuscles: ["abdominals", "hip flexors"], secondaryMuscles: ["forearms"] },
    { name: "Cable Crunch", nameKo: "케이블 크런치", bodyPart: "abs", equipment: "cable", category: "hypertrophy", difficulty: "beginner", primaryMuscles: ["abdominals"], secondaryMuscles: [] },
    { name: "Russian Twist", nameKo: "러시안 트위스트", bodyPart: "abs", equipment: "bodyweight", category: "strength", difficulty: "beginner", primaryMuscles: ["obliques"], secondaryMuscles: ["abdominals"] },
    { name: "Ab Wheel Rollout", nameKo: "AB 휠 롤아웃", bodyPart: "abs", equipment: "other", category: "strength", difficulty: "intermediate", primaryMuscles: ["core"], secondaryMuscles: ["lats", "shoulders"] },
    { name: "Mountain Climber", nameKo: "마운틴 클라이머", bodyPart: "full_body", equipment: "bodyweight", category: "cardio", difficulty: "beginner", primaryMuscles: ["core"], secondaryMuscles: ["shoulders", "legs"] },
    { name: "Burpee", nameKo: "버피", bodyPart: "full_body", equipment: "bodyweight", category: "cardio", difficulty: "intermediate", primaryMuscles: ["full body"], secondaryMuscles: ["cardiovascular system"] },
    { name: "Jump Rope", nameKo: "점프 로프", bodyPart: "full_body", equipment: "other", category: "cardio", difficulty: "beginner", primaryMuscles: ["cardiovascular system", "calves"], secondaryMuscles: ["shoulders", "forearms"] },
    { name: "Elliptical", nameKo: "일립티컬", bodyPart: "full_body", equipment: "machine", category: "cardio", difficulty: "beginner", primaryMuscles: ["cardiovascular system", "legs"], secondaryMuscles: ["glutes"] },
    { name: "Rowing Machine", nameKo: "로잉 머신", bodyPart: "full_body", equipment: "machine", category: "cardio", difficulty: "beginner", primaryMuscles: ["cardiovascular system", "back", "legs"], secondaryMuscles: ["arms", "core"] },
    { name: "Stair Climber", nameKo: "스테어 클라이머", bodyPart: "legs", equipment: "machine", category: "cardio", difficulty: "beginner", primaryMuscles: ["quadriceps", "glutes"], secondaryMuscles: ["calves", "cardiovascular system"] },
  ] as const;

  return rows.map((exercise) => ({
    ...exercise,
    description: `Basic ${exercise.name.toLowerCase()} exercise.`,
    descriptionKo: `${exercise.nameKo} 기본 운동입니다.`,
    instructions: ["자세를 안정적으로 잡습니다.", "목표 부위에 집중해 동작합니다.", "반동 없이 천천히 반복합니다."],
  }));
}
...
async function ensureMealTables() {
  ...
  const defaultFoods = [
    ...
    ["햇반 백미밥", "CJ/즉석밥", 145, 3, 32, 0.4, ["햇반", "CJ 햇반", "즉석밥", "햇반 작은공기", "햇반 큰공기"]],
    ["오뚜기밥 백미", "오뚜기/즉석밥", 145, 3, 32, 0.4, ["오뚜기밥", "오뚜기 밥", "즉석밥"]],
    ["햇반 현미쌀밥", "CJ/즉석밥", 140, 3.2, 30, 1, ["현미 햇반", "햇반 현미", "현미쌀밥"]],
    ["햇반 잡곡밥", "CJ/즉석밥", 142, 3.5, 30, 1.2, ["잡곡 햇반", "햇반 잡곡", "흑미밥"]],
    ["삼각김밥 참치마요", "편의점", 190, 4.8, 32, 5.2, ["참치마요삼각김밥", "참마삼김", "GS 참치마요", "CU 참치마요", "세븐일레븐 참치마요"]],
    ["삼각김밥 전주비빔", "편의점", 175, 4.2, 34, 2.8, ["전주비빔삼각김밥", "전주비빔", "GS 전주비빔", "CU 전주비빔"]],
    ["김치볶음밥 삼각김밥", "편의점", 180, 4.3, 35, 3, ["김볶삼김", "김치볶음 삼각김밥", "김치삼각김밥"]],
    ["편의점 닭가슴살 도시락", "편의점", 150, 14, 17, 3.5, ["다이어트도시락", "닭가슴살도시락", "CU 닭가슴살 도시락", "GS 닭가슴살 도시락"]],
    ["편의점 제육 도시락", "편의점", 190, 8, 24, 7, ["제육도시락", "GS 제육도시락", "CU 제육도시락", "한솥 제육"]],
    ["편의점 불고기 도시락", "편의점", 185, 8.5, 23, 6.5, ["불고기도시락", "GS 불고기 도시락", "CU 불고기 도시락"]],
    ["편의점 샐러드", "편의점", 70, 5, 8, 2.5, ["CU 샐러드", "GS 샐러드", "세븐일레븐 샐러드", "편샐"]],
    ["닭가슴살 볼", "간편단백질", 165, 22, 6, 5, ["닭가슴살볼", "닭볼", "닭가슴살 미트볼", "닭가슴살 큐브"]],
    ["닭가슴살 소시지", "간편단백질", 170, 20, 5, 7, ["닭소시지", "닭가슴살소세지", "닭가슴살 소세지", "닭쏘"]],
    ["훈제 닭가슴살", "간편단백질", 135, 28, 1, 2.5, ["훈제닭가슴살", "훈제닭", "닭찌 훈제", "하림 닭가슴살"]],
    ["수비드 닭가슴살", "간편단백질", 120, 25, 1, 2, ["수비드닭가슴살", "수비드닭", "닭찌 수비드"]],
    ["닭가슴살 스테이크", "간편단백질", 180, 22, 8, 6, ["닭스테이크", "닭가슴살스테이크", "닭가슴살 패티"]],
    ["참치마요 덮밥", "간편식", 210, 7, 29, 7, ["참치마요덮밥", "참마덮", "참치마요 컵밥"]],
    ["오뚜기 컵밥 제육덮밥", "오뚜기/컵밥", 170, 6, 27, 4.5, ["컵밥 제육", "제육컵밥", "오뚜기 제육덮밥"]],
    ["오뚜기 컵밥 김치참치덮밥", "오뚜기/컵밥", 165, 6, 27, 4, ["김치참치컵밥", "참치김치컵밥", "컵밥 김치참치"]],
    ["햇반 컵반 미역국밥", "CJ/컵반", 110, 4, 20, 1.5, ["컵반 미역국밥", "미역국밥", "CJ 컵반"]],
    ["햇반 컵반 스팸마요덮밥", "CJ/컵반", 215, 7, 29, 8, ["스팸마요컵반", "스팸마요덮밥", "컵반 스팸마요"]],
    ["컵누들 매콤한맛", "오뚜기/컵라면", 120, 2.5, 27, 0.8, ["컵누들", "컵누들 매콤", "다이어트 컵라면"]],
    ["컵누들 우동맛", "오뚜기/컵라면", 120, 2.5, 27, 0.8, ["컵누들 우동", "컵누들우동"]],
    ["신라면 컵", "농심/컵라면", 430, 9, 67, 14, ["신라면컵", "신컵", "신라면 작은컵", "농심 신라면"]],
    ["육개장 사발면", "농심/컵라면", 375, 7, 58, 13, ["육개장", "사발면", "육개장컵라면"]],
    ["불닭볶음면", "삼양/라면", 530, 12, 84, 17, ["불닭", "불닭면", "불닭 컵라면", "까르보불닭"]],
    ["짜파게티", "농심/라면", 610, 11, 96, 20, ["짜파", "짜장라면", "짜파게티 컵"]],
    ["맥도날드 빅맥", "프랜차이즈", 257, 12, 20, 14, ["빅맥", "맥날 빅맥", "McDonald Big Mac"]],
    ["맥도날드 상하이버거", "프랜차이즈", 250, 13, 22, 13, ["상하이버거", "상하이 스파이스 치킨", "맥날 상하이"]],
    ["버거킹 와퍼", "프랜차이즈", 270, 13, 22, 16, ["와퍼", "버거킹와퍼", "whopper"]],
    ["롯데리아 새우버거", "프랜차이즈", 245, 8, 30, 10, ["새우버거", "롯데리아 새우"]],
    ["맘스터치 싸이버거", "프랜차이즈", 300, 15, 28, 15, ["싸이버거", "맘터 싸이", "싸이 버거"]],
    ["서브웨이 로스트치킨 샌드위치", "프랜차이즈", 150, 10, 22, 3, ["서브웨이 로스트치킨", "섭웨 로스트치킨", "로스트치킨 샌드위치"]],
    ["서브웨이 터키 샌드위치", "프랜차이즈", 135, 9, 22, 2.5, ["서브웨이 터키", "섭웨 터키", "터키 샌드위치"]],
    ["스타벅스 카페라떼", "프랜차이즈", 55, 3, 5, 2.2, ["스벅 라떼", "스타벅스 라떼", "카페라떼 톨"]],
    ["스타벅스 아메리카노", "프랜차이즈", 2, 0.1, 0, 0, ["스벅 아메리카노", "아아", "아이스아메리카노"]],
    ["매일 두유 99.9", "음료", 55, 4.5, 2.5, 3, ["두유", "무가당두유", "매일두유", "99.9 두유"]],
    ["아몬드브리즈 언스위트", "음료", 17, 0.6, 0.4, 1.3, ["아몬드브리즈", "언스위트", "아몬드 우유"]],
    ["셀렉스 프로틴 음료", "보충제", 65, 10, 5, 1, ["셀렉스", "셀렉스 프로틴", "단백질음료"]],
    ["하이뮨 프로틴 밸런스", "보충제", 80, 10, 8, 1.5, ["하이뮨", "하이뮨 프로틴", "프로틴밸런스"]],
    ["마이프로틴 임팩트 웨이", "보충제", 400, 80, 8, 6, ["마프", "마이프로틴", "임팩트웨이", "웨이프로틴"]],
    ["신타6 프로틴", "보충제", 420, 50, 30, 12, ["신타", "신타식스", "syntha6", "프로틴파우더"]],
    ["단백질칩", "간식", 420, 25, 45, 14, ["프로틴칩", "단백질 과자", "프로틴 스낵"]],
    ["곤약젤리", "간식", 10, 0, 3, 0, ["곤약 젤리", "다이어트젤리", "저칼로리젤리"]],
    ["제로 아이스크림", "간식", 80, 3, 15, 2, ["라라스윗", "스키니피그", "제로아이스크림", "저칼로리아이스크림"]],
    ["그릭요거트볼", "간편식", 130, 9, 16, 3, ["그릭요거트 볼", "요거트볼", "그래놀라요거트"]],
